...
| OQ-06 | Provider email?                              | CI/local staging synthetic dùng file-mailbox; owner phải chọn/cấp HTTPS provider hỗ trợ idempotency trước môi trường có người dùng thật. | Trước UAT/staging có người dùng thật và không muộn hơn Gate P1 |
